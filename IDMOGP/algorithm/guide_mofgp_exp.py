...
# logging results
logging.basicConfig(level=logging.INFO, filename=file_name + 'guide_mofgp_exp_main.log')
logging.info('#############Start##############')
logging.info('Algorithm name: guide_mofgp_exp.py ')
...
def GPMain(randomSeeds):
    ...
    pop, log, best_front, hof, pop_store = evalGP.Guide_MOFGP(pop, toolbox, cxProb, mutProb, elitismProb, generation, pset,
...
if __name__ == "__main__":
    ...
    save_path = '../results/guide_mofgp_exp/'
    # save_path = '/vol/grid-solar/sgeusers/yingbi/MOGP_TUO/results/guide_mofgp_exp/'

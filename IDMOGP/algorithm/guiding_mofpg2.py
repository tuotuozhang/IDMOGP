...
def GPMain(randomSeeds):
    ...
    pop, log, best_front, hof = evalGP.Guiding_MOFGP(pop, toolbox, cxProb, mutProb, elitismProb, generation, pset,
                                                     indicator=indicators[1], stats=mstats, verbose=True)

    return pop, log, hof, best_front


if __name__ == "__main__":
    beginTime = time.process_time()
    pop, log, hof, best_front = GPMain(randomSeeds)

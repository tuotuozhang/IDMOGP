...
import saveFile
##image Data
from strongGPDataType import region, kernelSize, histdata, filterData, coordsX1, coordsX2, windowSize2, windowSize3, \
    poolingType
# defined by author
...
pset.addPrimitive(fs.gauD, [filterData, coordsX2, coordsX1, coordsX1], filterData, name='Gau_D1')
# general filters
